...
function DocumentPreview({
  ...
  return (
    <div style={{ marginBottom: 20 }}>
      ...
      >
        <div>
          <div style={{ fontSize: 13, fontWeight: 700, color: "#0f2342" }}>
            {label}
          </div>
          {number && (
...
export default function ApplicationDetailPage() {
    ...
    adminApi
      ...
      .then((r) => {
        if (r.success) {
          ...
          setNewEffectiveDate(
            r.data.effectiveDate ? r.data.effectiveDate.substring(0, 10) : "",
          );
          setNewSubmittedAt(
            r.data.submittedAt ? r.data.submittedAt.substring(0, 10) : "",
          );
        }
      })
  ...
  const saveEffectiveDate = async () => {
    ...
    setDateMsg("");
    try {
      const r = await adminApi.updateApplicationEffectiveDate(
        app.id,
        newEffectiveDate,
      );
      if (r.success) {
  ...
  const saveSubmittedAt = async () => {
    ...
    setSubmittedMsg("");
    try {
      const r = await adminApi.updateApplicationSubmittedAt(
        app.id,
        newSubmittedAt,
      );
      if (r.success) {
    ...
    <AdminLayout>
      <div style={{ padding: "32px 36px", maxWidth: 960 }}>
        ...
        <div style={{ fontSize: 13, color: "#94a3b8", marginBottom: 20 }}>
          <Link
            href="/applications"
            style={{ color: "#b8923a", textDecoration: "none" }}
          >
            Applications
          </Link>{" "}
          / #{app.id}
              ...
              <div>
                ...
                {editingSubmitted ? (
                  ...
                  >
                    ...
                    />
                    <button
                      onClick={saveSubmittedAt}
                      disabled={submittedUpdating}
                      style={{
                        padding: "4px 10px",
                        background: "#b8923a",
                        color: "#fff",
                    ...
                    <button
                      onClick={() => {
                        ...
                        setNewSubmittedAt(
                          app.submittedAt
                            ? app.submittedAt.substring(0, 10)
                            : "",
                        );
                      }}
                      style={{
                    ...
                    {submittedMsg && (
                      <span
                        style={{
                          fontSize: 12,
                          color: submittedMsg.includes("updated")
                            ? "#10b981"
                            : "#ef4444",
                        }}
                      >
                  ...
                  >
                    ...
                    <button
                      onClick={() => {
                        ...
                        setNewEffectiveDate(
                          app.effectiveDate
                            ? app.effectiveDate.substring(0, 10)
                            : "",
                        );
                      }}
                      style={{
                    ...
                    {dateMsg && (
                      <span
                        style={{
                          fontSize: 12,
                          color: dateMsg.includes("updated")
                            ? "#10b981"
                            : "#ef4444",
                        }}
                      >
          ...
          {app.investment && (
            <div className="card">
              ...
              >
                <InfoRow
                  label="Units"
                  value={String(app.investment.numUnits)}
                />
                <InfoRow
                  label="Total Amount"
                  value={
                    app.investment.totalAmount
                      ? `$${app.investment.totalAmount.toLocaleString()}`
                      : undefined
                  }
                />
                <InfoRow
                  label="Payment Method"
                  value={app.investment.paymentMethod}
                />
                <InfoRow
                  label="Distribution"
                  value={app.investment.distributionPreference}
                />
                <InfoRow label="Bank" value={app.investment.bankName} />
                <InfoRow
                  label="Account Holder"
                  value={app.investment.accHolder}
                />
                <InfoRow
                  label="Routing Number"
                  value={app.investment.routingNumber?.toString()}
                />
                <InfoRow
                  label="Account Number"
                  value={app.investment.accNumber}
                />
              </div>
            </div>
          )}
          ...
          <div className="card" style={{ marginBottom: 24 }}>
            ...
            >
              <InfoRow
                label="Name"
                value={[
                  app.investorProfile.firstName,
                  app.investorProfile.lastName,
                ]
                  .filter(Boolean)
                  .join(" ")}
              />
              ...
              <InfoRow
                label="Citizenship"
                value={app.investorProfile.citizenship}
              />
              <InfoRow
                label="Marital Status"
                value={app.investorProfile.maritalStatus}
              />
              <InfoRow
                label="Ownership Type"
                value={app.investorProfile.ownershipType}
              />
              <InfoRow label="SSN" value={app.investorProfile.ssNumberMasked} />
              <InfoRow
                label="Driving License No"
                value={app.investorProfile.drivingLicenseNo}
              />
              <InfoRow
                label="Driving License State"
                value={app.investorProfile.drivingLicenseState}
              />
            </div>
            ...
            >
              ...
              <InfoRow
                label="Night Phone"
                value={app.investorProfile.nightPhone}
              />
              <InfoRow label="Employer" value={app.investorProfile.employer} />
              <InfoRow
                label="Address"
                value={app.investorProfile.addressLine1}
              />
              <InfoRow
                label="City / State"
                value={[app.investorProfile.city, app.investorProfile.state]
                  .filter(Boolean)
                  .join(", ")}
              />
              ...
              <InfoRow
                ...
                value={app.investorProfile.mailingAddress}
              />
            </div>
            ...
            {app.investorProfile.maritalStatus?.toLowerCase() === "married" && (
              <>
                ...
                >
                  <InfoRow
                    label="Spouse Name"
                    value={app.investorProfile.spouseFullName}
                  />
                  <InfoRow
                    label="Spouse Email"
                    value={app.investorProfile.spouseEmail}
                  />
                  <InfoRow
                    label="Spouse SSN"
                    value={app.investorProfile.spouseSSN}
                  />
                  <InfoRow
                    label="Spouse DOB"
                    value={
            ...
            {app.investorProfile.entityName && (
              <>
                ...
                >
                  <InfoRow
                    label="Entity Name"
                    value={app.investorProfile.entityName}
                  />
                  <InfoRow label="EIN" value={app.investorProfile.ein} />
                  <InfoRow
                    label="State of Formation"
                    value={app.investorProfile.stateFormation}
                  />
                  <InfoRow
                    label="Signatory Name"
                    value={app.investorProfile.signatoryName}
                  />
                  <InfoRow
                    label="Signatory Title"
                    value={app.investorProfile.signatoryTitle}
                  />
                </div>
              </>
            )}
              ...
              <>
                ...
                >
                  <InfoRow
                    ...
                    value={app.investorProfile.custodianName}
                  />
                  <InfoRow
                    label="Account"
                    value={app.investorProfile.custodianAcct}
                  />
                  <InfoRow
                    label="Phone"
                    value={app.investorProfile.custodianPhone}
                  />
                  <InfoRow
                    label="Email"
                    value={app.investorProfile.custodianEmail}
                  />
                </div>
              </>
            )}
        ...
        {app.docuSignEnvelopeId &&
          (() => {
            const dbSigners = (() => {
              try {
                return app.docuSignSignersJson
                  ? JSON.parse(app.docuSignSignersJson)
                  : null;
              } catch {
                return null;
              }
            })();
            const displayStatus = dsStatus
              ? dsStatus.envelopeStatus
              : app.docuSignStatus;
            ...
            return (
              <div className="card" style={{ marginTop: 20 }}>
                ...
                >
                  <h2
                    style={{ fontSize: 15, fontWeight: 700, color: "#0f2342" }}
                  >
                    DocuSign Agreement
                  </h2>
                  <div
                  ...
                  >
                    {(!app.docuSignStatus ||
                      app.docuSignStatus === "created") &&
                      !["sent", "completed", "delivered"].includes(
                        dsStatus?.envelopeStatus ?? "",
                      ) && (
                        <button
                          onClick={sendDsEnvelope}
                          disabled={dsSending}
                          style={{
                            padding: "6px 14px",
                            background: "#10b981",
                            ...
                            fontWeight: 600,
                            color: "#fff",
                            cursor: dsSending ? "default" : "pointer",
                            opacity: dsSending ? 0.7 : 1,
                          }}
                        >
                    ...
                    {dsStatus?.lastSignerDate && (
                      <button
                        ...
                        style={{
                          ...
                          fontWeight: 600,
                          color: "#fff",
                          cursor: dsSyncing ? "default" : "pointer",
                          opacity: dsSyncing ? 0.7 : 1,
                        }}
                      >
                        {dsSyncing
                          ? "Setting…"
                          : "Set Effective Date from DocuSign"}
                      </button>
                    )}
                    {dsSyncMsg && (
                      <span
                    ...
                    {isCompleted && (
                      <button
                        ...
                        style={{
                          ...
                          fontWeight: 600,
                          color: "#fff",
                          cursor: dsDownloading ? "default" : "pointer",
                          opacity: dsDownloading ? 0.7 : 1,
                          display: "flex",
                          alignItems: "center",
                          gap: 6,
                        }}
                      >
                        <span>⬇</span>
                        {dsDownloading ? "Downloading…" : "Download PDF"}
                      </button>
                    )}
                  </div>
                </div>
                  ...
                  >
                    <span
                      style={{
                        ...
                        color: isCompleted ? "#059669" : "#92400e",
        ...
        {!app.docuSignEnvelopeId && (
          <div className="card" style={{ marginTop: 20 }}>
            ...
            >
              <h2 style={{ fontSize: 15, fontWeight: 700, color: "#0f2342" }}>
            ...
            {app.signedDocumentPath ? (
              ...
              <p style={{ fontSize: 13, color: "#94a3b8", marginBottom: 14 }}>
                No signed agreement on file. Upload a scanned PDF for this
                historical account.
              </p>
            )}
            <div
            ...
            >
              ...
              >
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSignedDocFile(e.target.files?.[0] ?? null)
                  }
                  style={{ display: "none" }}
                />
              </label>
              <button
                ...
                style={{
                  ...
                  color: "#fff",
                  cursor:
                    !signedDocFile || signedDocUploading
                      ? "default"
                      : "pointer",
                  opacity: !signedDocFile || signedDocUploading ? 0.5 : 1,
                }}
              >
                {signedDocUploading
                  ? "Uploading…"
              ...
              {signedDocMsg && (
                <span
                  style={{
                    fontSize: 12,
                    color: signedDocMsg.includes("successfully")
                      ? "#10b981"
                      : "#ef4444",
                  }}
                >
      ...
      {showEditModal && (
        <InvestmentEditModal
          ...
          onSaved={(_pending, _msg) => {
            ...
            adminApi.application(app.id).then((r) => {
              if (r.success && r.data) setApp(r.data);
            });
          }}
        />
      )}
