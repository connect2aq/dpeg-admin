...
function BodyViewer({ body }: { body?: string | null }) {
  ...
  if (!body)
    return (
      <span style={{ color: "#9ca3af", fontSize: 12 }}>— suppressed —</span>
    );
  return (
    <div>
      <button
...
export default function EmailLogsPage() {
  ...
  const openDetail = (id: number) => {
    ...
    adminApi
      .emailLog(id)
      .then((r) => {
        if (r.success) setDetail({ id, data: r.data });
      })
                            ...
                            {loadingDetail ? (
                              ...
                              >
                                ...
                                {detail.data.correlationId && (
                                  ...
                                  >
                                    Correlation ID:{" "}
                                    <code>{detail.data.correlationId}</code>
                                  </p>
                                )}
